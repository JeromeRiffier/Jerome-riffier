  ...
  <v-card>
    <v-row>
      <v-col cols="12" md="4" lg="6" class="pa-4">
        <v-img
          :src="card.logo"
          class="ma-1  mx-lg-12 image"
          height="100%"
          center
          contain
        ></v-img>
      </v-col>
      <v-col cols="12" md="8" lg="6" class="pa-4 align-self-center">
        <p class="mb-0" v-for="(detail, index) in card.details[$i18n.locale]" v-html="detail"></p>
