<template>
    <v-card class="pa-10 pb-0 permission_denied">
      <div id="particles-js"></div>
      <h1>{{error.statusCode}}</h1>
      <h3 v-if="error.statusCode === 404">
        Perdu dans l'<span>espace</span> mon site? <br> Hmm, on dirait que cette page n'existe pas.. Plus qu'a <NuxtLink to="/">revenir a l'accueil</NuxtLink>
      </h3>
      <h3 v-else>
        Oula, on dirais bien que c'est cassé... Plus qu'a <NuxtLink to="/">revenir a l'accueil</NuxtLink>
      </h3>
